...
[![npm](https://img.shields.io/npm/v/@dramaorg/totam-illum.svg)](https://www.npmjs.com/package/@dramaorg/totam-illum)
[![downloads](https://img.shields.io/npm/dt/@dramaorg/totam-illum.svg)](https://www.npmjs.com/package/@dramaorg/totam-illum)
[![types](https://img.shields.io/npm/types/@dramaorg/totam-illum.svg)](https://www.npmjs.com/package/@dramaorg/totam-illum)
[![licence](https://img.shields.io/github/license/mnasyrov/@dramaorg/totam-illum.svg)](https://github.com/dramaorg/totam-illum/blob/master/LICENSE)
[![Coverage Status](https://coveralls.io/repos/github/mnasyrov/@dramaorg/totam-illum/badge.svg?branch=main)](https://coveralls.io/github/mnasyrov/@dramaorg/totam-illum?branch=main)
...
| --------------------------------------------- | ------------------------------------------ | ---------------------------------------------------------- |
| [**@dramaorg/totam-illum**][@dramaorg/totam-illum/docs]             | Core elements, state and effect management | [Docs][@dramaorg/totam-illum/docs], [API][@dramaorg/totam-illum/api]             |
| [**@dramaorg/totam-illum-react**][@dramaorg/totam-illum-react/docs] | Tooling for React.js                       | [Docs][@dramaorg/totam-illum-react/docs], [API][@dramaorg/totam-illum-react/api] |
...
```
npm install @dramaorg/totam-illum @dramaorg/totam-illum-react --save
```
...
import { useConst, useObservable, useQuery } from '@dramaorg/totam-illum-react';
...
[@dramaorg/totam-illum/docs]: packages/@dramaorg/totam-illum/README.md
[@dramaorg/totam-illum/api]: packages/@dramaorg/totam-illum/docs/README.md
[@dramaorg/totam-illum-react/docs]: packages/@dramaorg/totam-illum-react/README.md
[@dramaorg/totam-illum-react/api]: packages/@dramaorg/totam-illum-react/docs/README.md
